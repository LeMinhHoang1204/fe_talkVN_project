...
function ChannelSideBar() {
  ...
  const channels = [
    ...
    {
      category: "KÊNH CHAT",
      items: ["Kênh-ăn", "Kênh-học", "Kênh-ngủ", "Kênh-nghỉ"],
    },
      ...
      <div className="flex-1 overflow-y-auto ">
        {channels.map((channel, index) => (
          <div key={index} className="mt-[20px] mb-[20px] ml-[14px] mr-[6px] ">
            {/* Channel title */}
            <span
              className="flex relative group items-center gap-2 p-[4px] text-[#80848E] stroke-[#80848E] cursor-pointer hover:bg-[#3A3C40] hover:text-[#DBDEE1] hover:stroke-[#DBDEE1] rounded-[4px] transition duration-200 ease-in-out"
            ...
            >
              ...
              {openStates[index] ? (
                // Chevron Down
                <svg
                  className="group-hover:stroke-[#80848E]"
                  xmlns="http://www.w3.org/2000/svg"
                  width="22"
                  height="22"
                  viewBox="0 0 22 22"
              ...
              <span className="ml-auto mr-4 relative group/icon flex items-center opacity-0 group-hover:opacity-100 ">
                ...
                >
                  <path
                    d="M11 4.58333V17.4167M4.58334 11H17.4167"
                    stroke="#F5F5F5"
                    stroke-opacity="0.4"
                    stroke-width="2"
                    stroke-linecap="round"
              ...
              <ul className="mt-2">
                {channel.items.map((item, index) => (
                  ...
                  >
                    {/* Icon # */}
                    <svg
                      className="mr-2 group-hover:stroke-[#80848E]"
                      xmlns="http://www.w3.org/2000/svg"
                      width="16"
                      height="16"
                      viewBox="0 0 22 22"
                    ...
                    >
                      <path
                        d="M3.66667 8.25H18.3333M3.66667 13.75H18.3333M9.16667 2.75L7.33333 19.25M14.6667 2.75L12.8333 19.25"
                        stroke="currentColor"
                        strokeWidth="2"
                        strokeLinecap="round"
                        strokeLinejoin="round"
                      ...
                      <span className="relative group/icon flex items-center">
                        ...
                        >
                          <g clip-path="url(#clip0_146_559)">
                            <path
                              d="M11.1629 13.5958C12.6646 13.5958 13.882 12.3784 13.882 10.8766C13.882 9.37488 12.6646 8.15748 11.1629 8.15748C9.66112 8.15748 8.44372 9.37488 8.44372 10.8766C8.44372 12.3784 9.66112 13.5958 11.1629 13.5958Z"
                              stroke="#DBDEE1"
                              stroke-width="2"
                              stroke-linecap="round"
                              stroke-linejoin="round"
