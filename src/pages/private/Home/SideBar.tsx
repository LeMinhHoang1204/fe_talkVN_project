...
const avatars = [
  ...
  { id: 4, imageUrl: "/avatar1.png", groupName: "" }, // Avatar cá nhân không có tên nhóm
];
...
const SideBar: React.FC = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-between h-screen py-4 bg-[#18092f]">
      ...
      <div className="flex flex-col items-center space-y-4" style={{ marginTop: '-5px' }}>
        {/* Logo web (trên cùng) */}
