...
const TopBarChannel: React.FC = () => {
  return (
    ...
    >
      <div className="font-semibold text-lg"># Kênh-mở-màn</div>
      <div className="flex items-center gap-4">
        <input
          type="text"
          placeholder="Tìm kiếm"
          className="bg-[#1e1f22] text-white px-3 py-1 rounded-md text-sm border border-[#444]"
        />
        <div className="flex gap-3">
          <div className="relative group/icon">
            {/* <img src="public\pin 1.png" className="w-5 h-5" /> */}
            <svg
